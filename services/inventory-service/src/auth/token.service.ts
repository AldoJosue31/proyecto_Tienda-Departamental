...
import {
  AUTH_JWT_ISSUER,
  isRole,
  type InventoryRuntimeConfig,
  type Role,
} from "../config/environment";

export const INVENTORY_RUNTIME_CONFIG = Symbol("INVENTORY_RUNTIME_CONFIG");
...
export class TokenService {
  constructor(
    ...
    private readonly config: Pick<InventoryRuntimeConfig, "accessSecret">,
  ) {}
