export default function DashboardLoading() {
  return (
    <div className="min-h-[100dvh] bg-[var(--page)]" aria-busy="true" aria-label="Cargando inventario">
      <div className="platform-page animate-pulse motion-reduce:animate-none">
